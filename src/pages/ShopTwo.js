                                                ...
                                                <Slider {...shopsettings}>
                                                        ...
                                                        <div className="row">
                                                            <div className="col-lg-6 ps-0 p-lg-5 pe-2 ps-5 pt-4" style={sliderstyle}>
                                                                <div className="card w-100 border-0 ps-lg-5 ps-0 bg-transparent bg-transparent-card">
                                                                    <h4 className="font-xssss text-danger ls-3 fw-700 ms-0 mt-4 mb-3">CAFTERIA</h4>
                                                                    <h2 className="fw-300 display1-size display2-md-size lh-2 text-grey-900">Today's Special <br /> <b className="fw-700"></b></h2>
                                                                    ...
                                                                    <a href="/singleproduct" className="fw-700 text-white rounded-xl bg-primary-gradiant font-xsssss text-uppercase ls-3 lh-30 mt-0 text-center d-inline-block p-2 w150">Buy Now</a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div className="style1 d-flex align-items-center bg-cyan">
                                                        <div className="row">
                                                            <div className="col-lg-6 ps-0 p-lg-5 pe-2 ps-5 pt-4" style={sliderstyle}>
                                                                <div className="card w-100 border-0 ps-lg-5 ps-0 bg-transparent bg-transparent-card">
                                                                    <h4 className="font-xssss text-white ls-3 fw-700 ms-0 mt-4 mb-3">CAFTERIA</h4>
                                                                    <h2 className="fw-300 display1-size display2-md-size lh-2 text-white">New Meals Arrival <br /> <b className="fw-700">Kibris Cuisines</b></h2>
                                                                    ...
                                                                    <a href="/singleproduct" className="fw-700 text-grey-900 rounded-xl bg-white font-xsssss text-uppercase ls-3 lh-30 mt-0 text-center d-inline-block p-2 w150">Buy Now</a>
                                                                </div>
                                                            </div>
                                                            <div className="col-lg-6"><img src="assets/images/product.png" alt="product" className="img-fluid p-md-5 p-4" /></div>
                                                        </div>
                                        ...
                                        <div key={index} className="col-lg-4 col-md-6" >
                                            <div className="card w-100 border-0 mt-4">
                                                ...
                                                <div className="card-body w-100 p-0 text-center">
                                                    ...
                                                    <h6 className="font-xsss fw-600 text-grey-500 ls-2">{value.price}TL</h6>
                                                </div>                                
                                            </div>
                                        </div>
